            ...
            [
                [
                    InlineKeyboardButton(
                        "• نـصـب بـوتك مـن هـنا •", url="https://t.me/XXX_xx_XXX0",
                    )
                ],
...
@Client.on_message(command(["برمج السورس", f"تيتوو", f"ورس", f"لسورس", f"سورس", f"تيتو"]) & filters.group & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/9c0a58152566d14393413.jpg",
        caption=f"""ᴘʀᴏɢʀᴀᴍᴍᴇʀ ](https://t.me/XXX_xx_XXX0) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𓌹ᴘʀᴏɢʀᴀᴍᴍᴇʀ↯●𓌺", url=f"https://t.me/XXX_xx_XXX0"),
            ],
            [
                InlineKeyboardButton(
                    "𝑬𝑹𝑹𝑶𝑹🖤", url=f"https://t.me/Q_o_lll"
                ),
            ],
            [
